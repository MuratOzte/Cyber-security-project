...
const Contact = () => {
    ...
    useEffect(() => {
        if (isInView) {
            dispatch(uiSlice.actions.setNavPosition('Contact'));
        }
    }, [isInView]);
                ...
                <div className="grid lg:grid-cols-3 items-center">
                    <div className="grid sm:grid-cols-2 gap-4 z-20 relative lg:left-16 max-lg:mb-8">
                        ...
                        >
                            ...
                            <h4
                                ref={container}
                                className="text-slate-900 text-base font-extrabold mt-5"
                            >
                                Call us
                            </h4>
                            <p className="text-sm text-slate-900 mt-2">
                    ...
                    <motion.div
                        ...
                        transition={{ bounce: 0.5, delay: 0.4 }}
                        className="lg:col-span-2 bg-3 rounded sm:p-10 p-4 z-10"
                    >
                        <motion.h2
                            animate={
                            ...
                            className="text-3xl text-white text-center font-extrabold mb-6"
                        >
                            Contact Us
                        </motion.h2>
                        <form>
                            <div className="max-w-sm mx-auto space-y-4">
                                <motion.input
                                    ...
                                    transition={{ bounce: 0.5, delay: 0.5 }}
                                    type="text"
                                    placeholder="Name"
                                ...
                                <motion.input
                                    ...
                                    transition={{ bounce: 0.5, delay: 0.6 }}
                                    type="email"
                                ...
                                <motion.textarea
                                    ...
                                    transition={{ bounce: 0.5, delay: 0.65 }}
                                    placeholder="Message"
                                    rows={6}
