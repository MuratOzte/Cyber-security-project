...
const Contact = () => {
  return (
    ...
    // </section>
    <React.Fragment>
      <div className="font-[sans-serif] max-w-6xl mx-auto relative bg-4 rounded my-6 mb-8 pt-9">
        <div className="grid lg:grid-cols-3 items-center">
          <div className="grid sm:grid-cols-2 gap-4 z-20 relative lg:left-16 max-lg:mb-8">
            <div className="flex flex-col items-center justify-center rounded w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
              ...
              <h4 className="text-slate-900 text-base font-extrabold mt-4">
                Visit office
              </h4>
            ...
            <div className="flex flex-col items-center justify-center rounded w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
              ...
              <h4 className="text-slate-900 text-base font-extrabold mt-5">
                Call us
              </h4>
              <p className="text-sm text-slate-900 mt-2">+158 996 888</p>
            </div>
            <div className="flex flex-col items-center justify-center rounded w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <p className="text-sm text-slate-900 mt-2">info@example.com</p>
            </div>
            <div className="flex flex-col items-center justify-center rounded w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="w-6 fill-4"
                viewBox="0 0 100 100"
              >
                <path
              ...
              <p className="text-sm text-slate-900 mt-2">+1-548-2588</p>
            </div>
          </div>
          <div className="lg:col-span-2 bg-3 rounded sm:p-10 p-4 z-10">
            <h2 className="text-3xl text-white text-center font-extrabold mb-6">
              Contact Us
            </h2>
            <form>
