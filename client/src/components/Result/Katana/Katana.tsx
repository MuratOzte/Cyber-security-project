...
import ktuData from '../../../data/ktu/katana-output.json';
import aspnetData from '../../../data/testaspnet/katana-output.json';
import htmlData from '../../../data/testhtml5/katana-output.json';
import phpData from '../../../data/testphp/katana-output.json';
import Divider from '../../common/Divider';
import Skeleton from '../../common/Skeleton';
import { useDispatch, useSelector } from 'react-redux';
import { RootState } from '../../../store';
import KatanaOuterBox from './KatanOuterBox';
                ...
                >
                    {result &&
                        result.map((e: any, index: number) => (
                            <KatanaOuterBox key={'key-' + index} item={e} />
                        ))}
