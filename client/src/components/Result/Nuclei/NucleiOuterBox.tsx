...
const NucleiBox: React.FC<NucleiBoxProps> = ({ item }) => {
    return (
        <div className="bg-nav border-gray-500 border-solid border-2 p-3 shadow-md shadow-gray-500 rounded-md w-auto mx-5 mt-4 flex flex-col justify-center space-y-3">
            {item &&
